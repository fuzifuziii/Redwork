...
* **Redwork** is heavily based on and inspired by [Autowork](https://github.com/Ict00/autowork) by Ict00.
* Original code, concepts, and underlying logic are subject to the original author's copyright.
...
### Авторы и лицензия
Проект с открытым исходным кодом, распространяется по лицензии **MIT**.

* **Redwork** во многом основан на идеях и коде мода [Autowork](https://github.com/Ict00/autowork) от Ict00.
* Оригинальный код, концепции и логика защищены авторским правом оригинального автора.

*Полный текст лицензии MIT — в файле `LICENSE` этого репозитория.*
